        ...
        def do_GET(self):
            ...
            if observer.installer:
                ...
                if message:
                    ...
                    body = body.replace(b'<button class="observer-candidate-button" ',
                                        b'<button class="observer-candidate-button" disabled aria-disabled="true" ')
